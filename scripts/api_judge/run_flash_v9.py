...
ROOT=Path(os.environ.get("V9_ROOT","/workspace/r2")); D=ROOT/"data"
...
RP.RUBRIC=open(Path(__file__).parent/"rubric_v9.txt",encoding="utf-8").read()
...
def work(fn):
    vp=VID/fn; row={"filename":fn,"model":model,"rubric":"v9","media":"LOW"}
